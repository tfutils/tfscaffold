...
- Are there missing changes (docs, CHANGELOG)?
...
- Variable values used in paths — any injection risk?
- S3 keys constructed safely?
- Backend config generation secure?
- No secrets or tokens in code?
- Hook scripts (pre.sh/post.sh) — any sourcing risks?

### 5. Terraform Conventions

- Component structure follows existing patterns?
- Variable naming consistent with existing conventions?
- Module interface changes backward-compatible?
...
### Security: [PASS/ISSUE]
### Terraform Conventions: [PASS/ISSUE]
