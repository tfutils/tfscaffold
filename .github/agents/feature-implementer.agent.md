...
understand the spec, implement, verify manually, self-review, commit, and
open a PR.
...
- Maintain consistency with existing patterns in `bin/terraform.sh`
...
Update `README.md` if the feature is user-facing (new flag, environment
